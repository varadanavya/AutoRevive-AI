...
exports.smartRetryEngine = exports.SmartRetryEngine = void 0;
const logger_1 = require("../utils/logger");
class SmartRetryEngine {
    /**
     * Calculate next retry execution time using Exponential Backoff + Jitter + Banking Windows
     */
    calculateNextRetry(input) {
        if (input.attemptNumber >= input.maxRetries) {
            logger_1.logger.info(`[Retry Engine] Max retries reached (${input.attemptNumber}/${input.maxRetries}). Stopping retry workflow.`);
            return null;
        }
        ...
        logger_1.logger.info(`[Retry Engine] Scheduled attempt ${attempt} at ${targetDate.toISOString()} (${strategyDescription})`);
        return {
...
exports.SmartRetryEngine = SmartRetryEngine;
exports.smartRetryEngine = new SmartRetryEngine();
